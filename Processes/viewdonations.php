...
// Compute totals for only 'Completed' donations
$totalAmount = 0;
...
<div class="container mt-5">
  ...
  <div class="mb-3">
    <h5>Total Completed Donations: <span class="text-success">KES <?= number_format($totalAmount, 2) ?></span></h5>
    <h6>Number of Completed Donations: <?= $totalCompletedDonations ?></h6>
  </div>
